...
public static void main(String[] args) {
	...
	Constructorexample e=new
			Constructorexample();
	Constructorexample e1=new
			Constructorexample (2);
	Constructorexample e3=new
			Constructorexample(3,5);
	Constructorexample e4=new
			Constructorexample("tejaswi",7);
